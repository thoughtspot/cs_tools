...
def temp_csv_for_upload(
    tmp: pathlib.Path, *, filename: str, data: _types.TableRowsFormat, include_header: bool = False
):
...
def batched(
    prepared_statement, *, session: sa.orm.Session, data: _types.TableRowsFormat, max_parameters: int = 999, **kw
) -> None:
